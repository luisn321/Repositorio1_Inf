...
class _PantallaPerfilClienteState extends State<PantallaPerfilCliente>
  ...
  late ServicioImagenes _servicioImagenes; // ✨ NUEVO
    ...
    try {
      ...
      if (token != null) {
        ...
        if (respuesta.statusCode == 200) {
          ...
          print(' Datos perfil recibidos: $datos');
          _usuarioActual = UsuarioModelo.desdeJson(datos);
          _ubicacionTextDelBackend = _usuarioActual?.direccionTexto ?? '';
        }
      }
    } catch (e) {
  ...
  Future<void> _guardarCambios() async {
    if (_usuarioActual == null) {
      _mostrarSnack('No hay datos de usuario', error: true);
      return;
    }
    ...
    if (_contrasenaNuevaCtrl.text.isNotEmpty) {
      ...
      if (_contrasenaNuevaCtrl.text != _confirmarContrasenaCtrl.text) {
        _mostrarSnack('Las contraseñas nuevas no coinciden', error: true);
        return;
      }
    }
    ...
    try {
      ...
      if (!mounted) return;
      _mostrarSnack('Error al guardar: ${e.toString()}', error: true);
    } finally {
  ...
  String get _nombreCompleto {
    ...
    return '$n $a'.trim().isEmpty ? 'Cliente' : '$n $a'.trim();
  }
  ...
  Future<void> _cambiarFotoPerfil() async {
    try {
      ...
      debugPrint('Error en _cambiarFotoPerfil: $e');
      if (mounted) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Sección: Cambiar contraseña (solo en edición)
                    if (_enEdicion) ...[
                      const SizedBox(height: 8),
        ...
        children: [
          ...
          SafeArea(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  // Fila superior: badge + botón editar
                  Row(
  ...
  Widget _buildCampo({
    ...
    int maxLineas = 1,
    bool siempreEditable = false,
  }) {
    final editable = siempreEditable || _enEdicion;
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: GoogleFonts.dmSans(color: _grisTexto),
            prefixIcon: Padding(
